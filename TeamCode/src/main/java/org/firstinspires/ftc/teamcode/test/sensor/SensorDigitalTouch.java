package org.firstinspires.ftc.teamcode.test.sensor;
 ...
 */
@TeleOp(name = "xavi uwu", group = "Pushbot")
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (digitalTouch.getState() == true) {
                telemetry.addData("Digital Touch", "No esta presionado");
            } else {
                telemetry.addData("Digital Touch", "Esta presionado");
            }
